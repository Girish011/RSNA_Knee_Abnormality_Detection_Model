"""Frozen v1 EN+ES keyword extractor.

Do not add French/German/other v2 patterns here. Consensus labeling uses this
module only to strip expert gold back to the shipped v1 skeleton.
"""
