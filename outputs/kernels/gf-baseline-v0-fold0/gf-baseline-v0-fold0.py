"""Train gf_baseline_v0 fold0 (frozen DINOv2-S) then score all 58 gold.

Writes under /kaggle/working/gf_baseline_v0/:
...
OUT = Path("/kaggle/working/gf_baseline_v0")
...
def main() -> None:
    ...
    print("=== gf_baseline_v0 fold0 vs full-58 gold ===")
